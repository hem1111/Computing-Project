            ...
            <div class="row">
                @if (isset($data['rows']) && $data['rows']->count() > 0)
                    @foreach($data['rows'] as $products)
                        <div class="col-md-6 col-lg-4" style="background: url({{asset('image/products/'.$products->image)}}) no-repeat center;">
                            <a href="{{route('user.product.singleview',$products->id)}}" class="a-block d-flex align-items-center height-md">
                                <div class="text">
                                    <div class="post-meta">
