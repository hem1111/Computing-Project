...
class orderController extends Controller
{
   ...
   return view('user.order.orderList',compact('data'));
    ...
    public function placeOrder(Product $id){
        $data=$id;
    ...
    //     $message->to('dressup@gmail.com','Dress Up');
...
$request->session()->flash('success_message',$this->panel.' is placed Successfully. It needs approval before processing.');
